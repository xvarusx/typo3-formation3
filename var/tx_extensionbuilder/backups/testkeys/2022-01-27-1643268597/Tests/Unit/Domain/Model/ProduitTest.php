...
class ProduitTest extends UnitTestCase
{
     ...
     * @test
     */
    public function getAddDateReturnsInitialValueForDateTime(): void
    {
        self::assertEquals(
            null,
            $this->subject->getAddDate()
        );
    }
     ...
     * @test
     */
    public function setAddDateForDateTimeSetsAddDate(): void
    {
        $dateTimeFixture = new \DateTime();
        $this->subject->setAddDate($dateTimeFixture);

        self::assertEquals($dateTimeFixture, $this->subject->_get('addDate'));
    }

    /**
     * @test
     */
    public function getUpdateDateReturnsInitialValueForDateTime(): void
    {
        self::assertEquals(
            null,
            $this->subject->getUpdateDate()
        );
    }
     ...
     * @test
     */
    public function setUpdateDateForDateTimeSetsUpdateDate(): void
    {
        $dateTimeFixture = new \DateTime();
        $this->subject->setUpdateDate($dateTimeFixture);

        self::assertEquals($dateTimeFixture, $this->subject->_get('updateDate'));
    }

    /**
     * @test
     */
    public function getDelateDateReturnsInitialValueForDateTime(): void
    {
        self::assertEquals(
            null,
            $this->subject->getDelateDate()
        );
    }
     ...
     * @test
     */
    public function setDelateDateForDateTimeSetsDelateDate(): void
    {
        $dateTimeFixture = new \DateTime();
        $this->subject->setDelateDate($dateTimeFixture);

        self::assertEquals($dateTimeFixture, $this->subject->_get('delateDate'));
    }
