...
class partial_Produit_FormFields_2305ad98810997bf74d141ebf3d0b810e70a998c extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments21['key'] = 'tx_testkeys_domain_model_produit.category';
...
$arguments23['optionsAfterContent'] = false;
...
$arguments23['name'] = 'paymentOptions';
$array25 = array (
);$arguments23['options'] = $renderingContext->getVariableProvider()->getByPath('produit.category', $array25);

$output0 .= TYPO3\CMS\Fluid\ViewHelpers\Form\SelectViewHelper::renderStatic($arguments23, $renderChildrenClosure24, $renderingContext);
