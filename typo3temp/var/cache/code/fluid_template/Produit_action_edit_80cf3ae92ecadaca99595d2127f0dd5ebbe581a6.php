...
class Produit_action_edit_80cf3ae92ecadaca99595d2127f0dd5ebbe581a6 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array15 = array (
);return $renderingContext->getVariableProvider()->getByPath('produit.categry.0.name', $array15);
};
$arguments13 = array();
...
$array18 = array (
);$arguments16['options'] = $renderingContext->getVariableProvider()->getByPath('produit.categry.0.name', $array18);
...
$array41 = array (
);return $renderingContext->getVariableProvider()->getByPath('produit.categry.0.name', $array41);
};
$arguments39 = array();
...
$array44 = array (
);$arguments42['options'] = $renderingContext->getVariableProvider()->getByPath('produit.categry.0.name', $array44);
