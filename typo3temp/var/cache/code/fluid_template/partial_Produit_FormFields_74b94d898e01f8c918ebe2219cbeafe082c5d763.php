...
class partial_Produit_FormFields_74b94d898e01f8c918ebe2219cbeafe082c5d763 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments21['optionsAfterContent'] = false;
...
$arguments21['name'] = 'paymentOptions';
$array23 = array (
);$arguments21['options'] = $renderingContext->getVariableProvider()->getByPath('produit.category', $array23);

$output0 .= TYPO3\CMS\Fluid\ViewHelpers\Form\SelectViewHelper::renderStatic($arguments21, $renderChildrenClosure22, $renderingContext);
